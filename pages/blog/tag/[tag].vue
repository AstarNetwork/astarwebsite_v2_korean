...
const query = gql`
query PostsByTag {
    posts(where: { space: { id_eq: "${astarSpace}" }, tagsOriginal_containsInsensitive: "${tag}", hidden_eq: false, AND: {space: { id_eq: "${astarSpace}" }, tagsOriginal_containsInsensitive: "blog", hidden_eq: false} }, orderBy: id_DESC) {
